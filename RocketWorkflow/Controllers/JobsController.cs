...
namespace RocketWorkflow.Controllers
{
    public class JobsController : Controller
    {
        ...
        {
            ViewBag.ClientId = new SelectList(db.Clients, "ClientId", "ApplicationUserId");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "JobId,ClientId,JobName,AssignedEmployee,DueDate,CompleteTime,Fee,IsComplete,IsArchived,BillingComplete,SomeProp")] Job job)
        {
